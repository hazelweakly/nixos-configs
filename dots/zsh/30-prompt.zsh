# Generated by Powerlevel10k configuration wizard on 2019-11-19 at 16:30 PST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh.
# Wizard options: awesome-fontconfig + powerline, large icons, lean, 2 lines, solid,
# no frame, lightest, sparse, many icons, fluent.
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=007
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION="${${IN_NIX_SHELL:+Λ}:-${${DIRENV_DIR:+Λ}:-λ}}"
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_ANCHOR_FOREGROUND=004
  #
  # typeset -g POWERLEVEL9K_DIR_CLASSES=()
  ...
  # Load color when load is between 50% and 002%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=003
  # Load color when load is over 002%.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%f at %003F%m'

  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=003
  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%n%f at %011F%m'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=006
  ...
  #################[ rust_version: rustc version (https://www.rust-lang.org) ]##################
  # Rust version color.
  typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND=006
  ...
  ###############[ dotnet_version: .NET version (https://dotnet.microsoft.com) ]################
  # .NET version color.
  typeset -g POWERLEVEL9K_DOTNET_VERSION_FOREGROUND=005
  ...
  #############[ rbenv: ruby version from rbenv (https://github.com/rbenv/rbenv) ]##############
  # Rbenv color.
  typeset -g POWERLEVEL9K_RBENV_FOREGROUND=009
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=009
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=005
  ...
  ################[ terraform: terraform workspace (https://www.terraform.io) ]#################
  # Terraform color.
  typeset -g POWERLEVEL9K_TERRAFORM_FOREGROUND=012
  # Custom icon.
  # typeset -g POWERLEVEL9K_TERRAFORM_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ aws: aws profile (https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-profiles.html) ]#
  # AWS profile color.
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=003
  ...
  typeset -g POWERLEVEL9K_AZURE_FOREGROUND=004
  # Custom icon.
  # typeset -g POWERLEVEL9K_AZURE_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=000
  # Custom icon.
  ...
  # typeset -g POWERLEVEL9K_EXAMPLE_FOREGROUND=003
