final: prev: {
  # really fuckin vendoring this whole ass thing because I can't be fucked to
  # override just the cargoSha256 "correctly"
  tree-sitter =
    let
      ts =
        { lib
        ...
        let
          ...
          update-all-grammars = callPackage (prev.path + "/pkgs/development/tools/parsing/tree-sitter/update.nix") { };
          ...
          grammars =
            ...
            '' + (lib.concatStrings (lib.mapAttrsToList
              ...
              (import (prev.path + "/pkgs/development/tools/parsing/tree-sitter/grammar.nix") { inherit lib; }))));

          buildGrammar = callPackage (prev.path + "/pkgs/development/tools/parsing/tree-sitter/grammar.nix") { };
          ...
          builtGrammars =
            let
              ...
              grammars' = import (prev.path + "/pkgs/development/tools/parsing/tree-sitter/grammars") { inherit lib; } // extraGrammars;
              grammars = grammars' //
